...
<?php foreach ($comments as $comment) : ?>
	...
	<div class="comment-content"><?php echo get_avatar( $comment, 32 ); ?>
	<?php comment_text() ?></div>
	<p><cite><?php comment_type(_x('Comment', 'noun'), __('Trackback'), __('Pingback')); ?> <?php _e('por'); ?> <?php comment_author_link() ?> &#8212; <?php comment_date() ?> @ <a href="#comment-<?php comment_ID() ?>"><?php comment_time() ?></a></cite> <?php edit_comment_link(__("Edit This"), ' | '); ?></p>
	</li>
